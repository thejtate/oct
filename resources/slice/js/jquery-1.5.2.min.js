...
(function (a, b) {
  ...
  function bQ(a, b, c, e) {
    ...
    }); else if (c || b == null || typeof b !== "object")e(a, b); else if (d.isArray(b) || d.isEmptyObject(b))e(a, ""); else for (var f in b)bQ(a + "[" + f + "]", b[f], c, e)
  }
      ...
      for (j = 0, k = f.length; j < k; j++) {
        ...
        for (i = 0; i < t.length; i++) {
          ...
          if (m.selector === g.selector && (!n || n.test(g.namespace)) && !m.elem.disabled) {
            ...
            (!e || e !== h) && p.push({elem: h, handleObj: g, level: m.level})
          }
        }
      }
  ...
  var c = a.document, d = function () {
    ...
    d.fn = d.prototype = {
      ...
      }, push: B, sort: [].sort, splice: [].splice
      ...
      noConflict: function (b) {
        ...
        if (!x) {
          ...
          if (c.addEventListener)c.addEventListener("DOMContentLoaded", y, !1), a.addEventListener("load", d.ready, !1); else if (c.attachEvent) {
    ...
    attr: function (a, b) {
      ...
      return this.each(function (b) {
        ...
        if (this.nodeType === 1) {
          ...
          if (d.isArray(e) && q.test(this.type))this.checked = d.inArray(c.val(), e) >= 0; else if (d.nodeName(this, "select")) {
            var f = d.makeArray(e);
  ...
  d.event = {
    ...
    special: {
      ready: {setup: d.bindReady, teardown: d.noop}, live: {
        add: function (a) {
          d.event.add(this, H(a.origType, a.selector), d.extend({}, a, {handler: G, guid: a.handler.guid}))
        }, remove: function (a) {
  ...
  if (!d.support.changeBubbles) {
    ...
    d.event.special.change = {
      filters: {
        focusout: D, beforedeactivate: D, click: function (a) {
          var b = a.target, c = b.type;
  ...
  var F = {focus: "focusin", blur: "focusout", mouseenter: "mouseover", mouseleave: "mouseout"};
    ...
    load: function (a, c, e) {
      ...
      return this.map(function () {
        ...
        return c == null ? null : d.isArray(c) ? d.map(c, function (a, c) {
          return {name: b.name, value: a.replace(bt, "\r\n")}
    ...
    show: function (a, b, c) {
      ...
      return this[f.queue === !1 ? "each" : "queue"](function () {
        ...
        b.overflow != null && (this.style.overflow = "hidden"), b.curAnim = d.extend({}, a), d.each(a, function (c, e) {
          ...
          if (ca.test(e))f[e === "toggle" ? g ? "show" : "hide" : e](a); else {
