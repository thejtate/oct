...
<div id="node-<?php print $node->nid; ?>" class="node<?php if ($sticky) {
  ...
  <div class="content-item-messeges">
    <div class="title-item-messeges">
      <div class="user-name">
        <?php if(isset($node->name) && !empty($node->name)): ?>
          <span class="author-name"><?php print $node->name; ?></span>
          <span><?php print t('said'); ?></span>
        <?php endif; ?>
      </div>
    ...
    <div class="rating-messages"><?php print $node->content['vud_node_widget_display']['#value']; ?></div>
  </div>
</div>