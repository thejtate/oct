...
<div class="b-info">
    ...
    <h2><?php print l($fields['title']->raw, 'enrollment/'.$fields['nid']->content, array('attributes' => array('name' => 'camp-'.$fields['nid']->content))); ?></h2>
      ...
      <?php if($fields['date_from']): ?>
        <p class="float-left" ><b><?php print t('Class Dates') . ' : '; ?></b>&nbsp;</p>
      ...
      <?php if($fields['date_from']): ?>
        <p class="float-left"  ><b><?php print t('Class Time') . ' : '; ?></b>&nbsp;</p>
