    ...
    <div id="content-bot">
      <div id="content-area">
        ...
        <div class="membership-top">
          <h2><?php print $node->field_membeship_family[0]['value']; ?></h2>
          <p><?php print $node->field_membeship_family[1]['value']; ?></p>
          <h2><?php print $node->field_membeship_single[0]['value']; ?></h2>
          <p><?php print $node->field_membeship_single[1]['value']; ?></p>
        </div>
        <?php print $field_membeship_text[0]['value']; ?>
      </div>
    </div>
  </div>
</div>